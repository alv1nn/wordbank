...
class French_French_WS(BaseTable):
    ...
    item_607_choices = [(u'produces', u'produces')]
    ...
    item_691_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_691 = models.CharField(max_length=3, choices=item_691_choices, null=True)
    item_692_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_692 = models.CharField(max_length=3, choices=item_692_choices, null=True)
    item_693_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_693 = models.CharField(max_length=3, choices=item_693_choices, null=True)
    item_694_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_694 = models.CharField(max_length=3, choices=item_694_choices, null=True)
    item_695_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_695 = models.CharField(max_length=7, choices=item_695_choices, null=True)
    item_696_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_696 = models.CharField(max_length=7, choices=item_696_choices, null=True)
    item_697_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_697 = models.CharField(max_length=7, choices=item_697_choices, null=True)
    item_698_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_698 = models.CharField(max_length=7, choices=item_698_choices, null=True)
    item_699_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_699 = models.CharField(max_length=7, choices=item_699_choices, null=True)
    item_700_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_700 = models.CharField(max_length=7, choices=item_700_choices, null=True)
    item_701_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_701 = models.CharField(max_length=7, choices=item_701_choices, null=True)
    item_702_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_702 = models.CharField(max_length=7, choices=item_702_choices, null=True)
    item_703_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_703 = models.CharField(max_length=7, choices=item_703_choices, null=True)
    item_704_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_704 = models.CharField(max_length=7, choices=item_704_choices, null=True)
    item_705_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_705 = models.CharField(max_length=7, choices=item_705_choices, null=True)
    item_706_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_706 = models.CharField(max_length=7, choices=item_706_choices, null=True)
    item_707_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_707 = models.CharField(max_length=7, choices=item_707_choices, null=True)
    item_708_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_708 = models.CharField(max_length=7, choices=item_708_choices, null=True)
    item_709_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_709 = models.CharField(max_length=7, choices=item_709_choices, null=True)
    item_710_choices = [(u'simple', u'simple'), (u'complex', u'complex')]
    item_710 = models.CharField(max_length=7, choices=item_710_choices, null=True)
    item_711_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_711 = models.CharField(max_length=3, choices=item_711_choices, null=True)
    item_712_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_712 = models.CharField(max_length=3, choices=item_712_choices, null=True)
    item_713_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_713 = models.CharField(max_length=3, choices=item_713_choices, null=True)
    item_714_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_714 = models.CharField(max_length=3, choices=item_714_choices, null=True)
    item_715_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_715 = models.CharField(max_length=3, choices=item_715_choices, null=True)
    item_716_choices = [(u'no', u'no'), (u'yes', u'yes')]
    item_716 = models.CharField(max_length=3, choices=item_716_choices, null=True)
